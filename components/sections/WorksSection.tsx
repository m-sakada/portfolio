...
export default function WorksSection({ works }: WorksSectionProps) {
  ...
  return (
    <section className="py-8 px-4 sm:py-12 md:py-16 lg:py-20 bg-gray-50 dark:bg-gray-800">
      <div className="max-w-6xl mx-auto">
        <h2 className="flex items-center justify-center gap-2 text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-6 sm:mb-8">
          ...
          <span className="text-sm sm:text-base font-normal text-gray-600 dark:text-gray-300 translate-y-[2px]">- 実績例 -</span>
        </h2>
